...
describe('inRangeNumber', () => {
  ...
  test('should return true for numbers in different formats within the range', () => {
    ...
    expect(inRangeNumber(0b11111111, 100, 300)).toBe(true);   // Binary
