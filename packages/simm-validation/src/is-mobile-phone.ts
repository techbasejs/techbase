 ...
 * @param {MobilePhoneLocale} locale The locale of regex.
 * @returns {boolean} Returns true if the string is phone, false otherwise.
 *
 */
const checkIsValidPhone = (input: string, locale: MobilePhoneLocale) => {
  const phoneRegex = MOBILE_PHONE_NUMBER[locale];
 ...
 * @param {MobilePhoneLocale} locale The locale of phone.
 * @returns {boolean} Returns true if the string is phone, false otherwise.
 *
 * @example
 * ```typescript
 * isMobilePhone("+84789550792"); // true
 * isMobilePhone("(555) 555-1234", "en-US"); // true
